...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA CLASICA BLANCA</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/viajera/cartera-rk-viajera-0007.jpg">
			...
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">CLASICA B</p>
				<div class="descripcion-articulo">
					<p>28 x 48 x 25 x 25 - 45 cm<br>
					(Alto x Largo x Ancho x Alto Asa Corta - Alto Asa Larga)<br><br>
					Sobria, elegante, un clasico blanco con una especial textura. Viajera en libertad.<br><br>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/vj/enviar-vj-07.php">
