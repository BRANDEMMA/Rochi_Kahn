		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/petit-ro/cartera-rk-petit-ro-0004.jpg">
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Telar en sus propias caracteristicas, gamuza enmarcando la combinacion y la sonrisa de una flor en lana de oveja color naranja la hace sin igual.<br>
