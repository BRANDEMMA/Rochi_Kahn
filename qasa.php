		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/peru-lujo/cartera-rk-peru-lujo-0009.jpg">
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Cartera de tonalidades blancas entre el telar desarollado de manera especial para la colección, entremesclado con piel del mismo tono con destellos de negro y detalles en un cuero azulino despertando el color.<br>
					Medidas: 40x30x12y15. (largo x alto x ancho y asas)<br>
