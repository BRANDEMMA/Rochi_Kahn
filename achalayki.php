...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA ACHALAYKI</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/peru-lujo/cartera-rk-peru-lujo-0013.jpg">
			...
			<div class="derecha-articulo">
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/pl/enviar-pl-10.php">
