...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA LABRADA FLORES</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/petit-ro/cartera-rk-petit-ro-0007.jpg">
			...
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">LABRADA FLORES</p>
				<div class="descripcion-articulo">
					<p>15 x 20 x 15 cm<br>
					(Alto x Largo x Alto Asa Corta)<br><br>
					Vanite  en piel especialmente dibujada y pintada a mano en alegres colores. No necesitas mas.<br><br>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/pr/enviar-pr-07.php">
