...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA - FLORES ENCENDIDAS ITALIANO</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/seduce-color/cartera-rk-seduce-color-0003-1.jpg">
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/seduce-color/cartera-rk-seduce-color-0003-2.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/seduce-color/cartera-rk-seduce-color-0003-3.jpg">
				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/seduce-color/cartera-rk-seduce-color-0003-1.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/seduce-color/cartera-rk-seduce-color-0003-2.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/seduce-color/cartera-rk-seduce-color-0003-3.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					...
					- Doble asa para el hombro o mano en mismo cuero.<br>
					- Forro interior en tono.<br>
					- 3 bolcillos interinos, 1 con cierre.</p>
					<p><span>S/ 800 Soles</span></p>
					<div class="botones">
				<!--<a href="#solicitar"><i class="fa fa-shopping-cart"></i>COMPRAR</a>-->
						...
						<a href="javascript:void( window.open('https://www.facebook.com/share.php?u=http%3A%2F%2Frochikahn.com%2Fflores-encendidas-italiano.php&t=ROCHI%20KAHN%20-%20BOLSO%20-%20CARTERA%20-%20FLORES%20ENCENDIDAS%20ITALIANO', 'blank','scrollbars=yes,toolbar=no,width=700,height=500'))" target="_blank"><i class="fa fa-facebook"></i></a>
						<a href="javascript:void( window.open('https://twitter.com/intent/tweet?text=ROCHI%20KAHN%20-%20BOLSO%20-%20CARTERA%20-%20FLORES%20ENCENDIDAS%20ITALIANO%20http%3A%2F%2Frochikahn.com%2Fflores-encendidas-italiano.php&source=webclient', 'blank','scrollbars=yes,toolbar=no,width=700,height=500'))" target="_blank">
						<i class="fa fa-twitter"></i></a>
						<a href="whatsapp://send?text=http%3A%2F%2Frochikahn.com%2Fflores-encendidas-italiano.php&t=ROCHI%20KAHN%20-%20BOLSO%20-%20CARTERA%20-%20FLORES%20ENCENDIDAS%20ITALIANO" data-action="share/whatsapp/share"><i class="fa fa-whatsapp"></i></a>
					</div> 
				</div>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/sc/enviar-sc-03.php">
