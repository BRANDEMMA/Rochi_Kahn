		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/petit-ro/cartera-rk-petit-ro-0005-1.jpg" >
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/petit-ro/cartera-rk-petit-ro-0005-2.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/petit-ro/cartera-rk-petit-ro-0005-3.jpg">
				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/petit-ro/cartera-rk-petit-ro-0005-1.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/petit-ro/cartera-rk-petit-ro-0005-2.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/petit-ro/cartera-rk-petit-ro-0005-3.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Un impresindible accesorio, pequeño con ganas de lucirse. Cuero blanco floreado, la estacion la eliges puede ser para cualquier lugar del mundo.<br>
					Medidas: 15 x 20 y 15  (alto x largo y asa corta)<br>
