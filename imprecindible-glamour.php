...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA IMPRECINDIBLE GLAMOUR</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/intervenidas/cartera-rk-intervenida-41.jpg">
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/intervenidas/cartera-rk-intervenida-42.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/intervenidas/cartera-rk-intervenida-43.jpg">

				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-41.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-42.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-43.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">IMPRECINDIBLE GLAMOUR</p>
				<div class="descripcion-articulo">
					<p>	Serán lujo y glamour que podrás lucir como un objeto de arte llevandola contigo o decorando definitivamente de manera original un espacio elegido.<br>
					</p>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/in/enviar-in-04.php">
