...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA SEDUCTORA GLAMOUR</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/intervenidas/cartera-rk-intervenida-21.jpg">
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/intervenidas/cartera-rk-intervenida-22.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/intervenidas/cartera-rk-intervenida-23.jpg">

				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-21.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-22.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-23.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">SEDUCTORA GLAMOUR</p>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/in/enviar-in-02.php">
