		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/viajera/cartera-rk-viajera-0005.jpg">
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Sobervia combinacion de texturas y colores en cada material que viste a este viajero, telares trabajados solo para esclusividad, cueros elegidos para la composicion especial y te lleve a lucir por donde vayas una pieza solo para ti.<br>
					Medidas: 26 x 48 x 15 – 15 y 45 (alto x largo x ancho, asa corta, asa larga)<br>
