...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA FLORES Y TONOS ROMANTICOS ROJOS Y AZULES</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/seduce-color/cartera-rk-seduce-color-0004-1.jpg">
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/seduce-color/cartera-rk-seduce-color-0004-2.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/seduce-color/cartera-rk-seduce-color-0004-3.jpg">

				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/seduce-color/cartera-rk-seduce-color-0004-1.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/seduce-color/cartera-rk-seduce-color-0004-2.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/seduce-color/cartera-rk-seduce-color-0004-3.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/sc/enviar-sc-04.php">
