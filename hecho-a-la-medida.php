...
<head>
	...
	<title>ROCHI KAHN - Hecho a la Medida</title>
...
<body>
	<div class="contenedor">
		...
		<div class="disena-tu-momento">
			<div class="logo2">
				<img src="img/hecho-a-la-medida/logo-hecho-a-la-medida.gif">
		...
		<div class="img-disena">
			<img src="img/hecho-a-la-medida/hecho-a-la-medida.jpg">
		...
		<p class="edicion">Rochi Kahn desarrolla y presenta el concepto  de <strong>Hecho a la Medida</strong>.


</p><br>

			<p class="edicion">Es el servicio de diseñar con cada cliente una cartera o bolso unico y personalizado según su estilo. 
			Le permite elegir entre ciertos modelos y construir en ellos inumerables combinaciones de cuero, colores, texturas, pieles, haciendo un diseño a la medida.</p><br>
			<p class="edicion">
			Rochi Kahn se presenta en el lugar que se coordine o recogen a quien vivira la experiencia de un diseño Hecho a la Medida, llevandola al espacio coordinado con la diseñadora.
			Un viaje creativo para una edicion unica y especial.<br><br>
			</p>
		...
		<div class="galeria-disena">
			...
			<a href="img/hecho-a-la-medida/gal1.jpg" data-lightbox="example-set"><img src="img/hecho-a-la-medida/gal1.jpg"></a>
			<a href="img/hecho-a-la-medida/gal2.jpg" data-lightbox="example-set"><img src="img/hecho-a-la-medida/gal2.jpg"></a>
			<a href="img/hecho-a-la-medida/gal3.jpg" data-lightbox="example-set"><img src="img/hecho-a-la-medida/gal3.jpg"></a>
			<a href="img/hecho-a-la-medida/gal4.jpg" data-lightbox="example-set"><img src="img/hecho-a-la-medida/gal4.jpg"></a>
