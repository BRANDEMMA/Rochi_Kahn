...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA YANA</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/peru-lujo/cartera-rk-peru-lujo-0011.jpg">
				...
				<a class="boton" href="peru-de-lujo.php#peru-lujo-mostrar"><i class="fa fa-caret-left"></i>VOLVER</a>								
			</div>
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">YANA</p>
				<div class="descripcion-articulo">
					<p>40 x 30 x 12 x 15 cm<br>
					(Largo x Alto x Ancho x Alto Asas)<br><br>
					Cartera en cuero tramado negro empalmado con telar rombos amplios negro sobre crudo especialmente diseñado y elaborado para la colección, ademas del tallado a mano de la piedra marmolina haciendo una flor adorno centro de cartera y ribetre en cuero rojo. <br><br>
					- Cierre en boca principal.<br>
					- Doble asa para el hombro o mano.<br>
					- Argollas media luna en niquel.<br>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/pl/enviar-pl-02.php">
