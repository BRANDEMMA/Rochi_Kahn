		...
		<div class="contenedor-articulo">
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Cartera en cuero tramado negro empalmado con telar rombos amplios negro sobre crudo especialmente diseñado y elaborado para la colección, ademas del tallado a mano de la piedra marmolina haciendo una flor adorno centro de cartera y ribetre en cuero rojo. <br>
					Medidas: 40 x 30 x 12 y 15. (largo x altox ancho y asas)<br>
