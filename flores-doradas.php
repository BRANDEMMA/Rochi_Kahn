		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/petit-ro/cartera-rk-petit-ro-0001-1.jpg" >
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/petit-ro/cartera-rk-petit-ro-0001-2.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/petit-ro/cartera-rk-petit-ro-0001-3.jpg">
				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/petit-ro/cartera-rk-petit-ro-0001-1.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/petit-ro/cartera-rk-petit-ro-0001-2.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/petit-ro/cartera-rk-petit-ro-0001-3.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Sobre mediano en destello de flores doradas sobresalen en el cuero estampado de fondo negro.<br>
					Medidas: 24 x 28 y 15  (alto x largo y asa corta)<br>
					Tapa con broche imantado.<br>
					Asa corta de mano.<br>
					Forro interior en tono color.<br>
					2 bolcillos internos.<br>
					Placa marca en bronce.</p>
