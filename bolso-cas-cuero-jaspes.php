...
<head>
	...
	<title>ROCHI KAHN - BOLSO- CARTERA CAs CUERO JASPES</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/versatil/cartera-rk-versatil-0005.jpg" >
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/versatil/cartera-rk-versatil-0005-2.jpg">
					
				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/versatil/cartera-rk-versatil-0005.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/versatil/cartera-rk-versatil-0005-2.jpg"></a>
			...
			<div class="derecha-articulo">
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/vs/enviar-vs-05.php">
