...
<head>
	...
	<title>ROCHI KAHN - BOlSO - CARTERA TELAR NEGRO Y BLANCO</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/viajera/cartera-rk-viajera-0006.jpg">
			...
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">TELAR NB</p>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/vj/enviar-vj-06.php">
