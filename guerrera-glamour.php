		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img id="tentacion-presentacion-1" src="img/productos/intervenidas/cartera-rk-intervenida-51.jpg">
					<img id="tentacion-presentacion-2" style="display:none;" src="img/productos/intervenidas/cartera-rk-intervenida-52.jpg">
					<img id="tentacion-presentacion-3" style="display:none;" src="img/productos/intervenidas/cartera-rk-intervenida-53.jpg">

				</div>
				<div class="miniaturas-articulos">
					<a id="tentacion-miniatura-1" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-51.jpg"></a>
					<a id="tentacion-miniatura-2" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-52.jpg"></a>
					<a id="tentacion-miniatura-3" style="cursor:pointer;"><img src="img/productos/intervenidas/cartera-rk-intervenida-53.jpg"></a>
					<div class="clear"></div>
				</div>
				<div class="clear"></div>
			...
			<div class="derecha-articulo">
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/in/enviar-in-05.php">
