		...
		<div class="contenedor-articulo">
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>35.0 a 38.0 x 30.0 x 15 (largo x alto x ancho)<br>
					Destello en la oscuridad, elegantes y doradas flores resaltan en el enigmatico y siempre deseado color negro, dos tonos de rigos en un cuero seductor.<br>
