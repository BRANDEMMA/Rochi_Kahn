		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/peru-lujo/cartera-rk-peru-lujo-0012.jpg">
			...
			<div class="derecha-articulo">
				...
				<div class="descripcion-articulo">
					<p>Cartera en destellante cuero rojo impactado al predominante telar geometrico en hueso y negro, hecho especialmente para la colección y especial aplicación de flor tallada a mano en piedra marmolina hecha por artersanos de Cajamarca-Peru.<br>
					Medidas: 40x 30x 12y15 (largo x alto x ancho y asas)<br>
