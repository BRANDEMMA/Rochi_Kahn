...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA PIEL Y COLORES</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/viajera/cartera-rk-viajera-0001.jpg">
			...
			<div class="derecha-articulo">
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/vj/enviar-vj-01.php">
