...
<head>
	...
	<title>ROCHI KAHN - BOLSO - CARTERA CLASICA NEGRA</title>
		...
		<div class="contenedor-articulo">
			<div class="izquierda-articulo">
				<div class="presentacion-articulo">
					<img src="img/productos/viajera/cartera-rk-viajera-0008.jpg">
				...
				<a class="boton" href="viajeras.php#viajeras-mostrar"><i class="fa fa-caret-left"></i>VOLVER</a>								
			</div>
			<div class="derecha-articulo">
				<p class="titulo-derecha-articulo">CLASICA N</p>
				<div class="descripcion-articulo">
					<p>28 x 48 x 25 x 25 - 45 cm<br>
					(Alto x Largo x Ancho x Alto Asa Corta - Alto Asa Larga)<br><br>
					Elegante y combinable cuero negro plomizo en texturas lineales. Ejecutivamente viajera.<br><br>
				...
				<div class="formulario-articulo" id="solicitar">
					...
					<form class="form-main" name="ajax-form" id="ajax-form" method="POST" action="php/vj/enviar-vj-08.php">
